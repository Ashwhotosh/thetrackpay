...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-x-hidden">
      {activeSection === "home" ? (
        /* Home uses the banner-style header (logo + glassy nav pill + CTA). */
        <HomeHeader activeSection={activeSection} setActiveSection={navigate} />
      ) : (
        <>
          {/* Global Nirmaan Pre-incubation Badge (non-home sections) */}
          <div
